...
ALT_GAS_CAR: Set[str] = set()  # these cars use a different gas signal
EV_HYBRID = ALT_GAS_CAR | set([CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_NIRO_EV])
